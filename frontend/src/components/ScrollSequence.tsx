...
export default function ScrollSequence() {
  ...
  const navBackground = useTransform(scrollYProgress, [0, 0.05], ["rgba(0,0,0,0)", "rgba(0,0,0,0.6)"]);
  ...
  return (
    <div ref={containerRef} style={{ height: "600vh", position: "relative" }}>
      <div style={{ position: "sticky", top: 0, height: "100vh", width: "100vw", overflow: "hidden", backgroundColor: "#000" }}>
        ...
        <div style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "140px", background: "linear-gradient(to bottom, rgba(0,0,0,0.5) 0%, rgba(0,0,0,0) 100%)", zIndex: 5, pointerEvents: "none" }} />

        {/* Navbar */}
        <motion.div className="nav-container" style={{ position: "absolute", top: 0, left: 0, width: "100%", display: "flex", justifyContent: "space-between", alignItems: "center", zIndex: 10, background: navBackground }}>
          ...
          <div className="nav-links" style={{ color: "white", fontWeight: 500, textShadow: "0 1px 4px rgba(0,0,0,0.5)" }}>
            <a href="#" style={{ transition: "opacity 0.2s", display: "flex", flexDirection: "column", alignItems: "center" }} onMouseEnter={e => e.currentTarget.style.opacity = "0.7"} onMouseLeave={e => e.currentTarget.style.opacity = "1"}>
