...
export default function CallExperience({ isActive, onClose }: CallExperienceProps) {
  ...
  useEffect(() => {
    ...
    sequenceInterval = setInterval(() => {
      ...
      if (t === 4) {
        setMessages(prev => [...prev, { id: "1", speaker: "RAAHI", text: "आप किस जिले से बात कर रहे हैं?" }]);
      }
      // 7s: User answers
      if (t === 7) {
        setMessages(prev => [...prev, { id: "2", speaker: "USER", text: "नालंदा से।" }]);
      }
      ...
      if (t === 13) {
        setMessages(prev => [...prev, { id: "3", speaker: "RAAHI", text: "आप खेती के अलावा कोई काम करना चाहेंगे?" }]);
      }
      // 16s: User answers
      if (t === 16) {
        setMessages(prev => [...prev, { id: "4", speaker: "USER", text: "हाँ, मोबाइल रिपेयरिंग सीखना चाहता हूँ।" }]);
      }
  ...
  return (
    ...
    >
      <div className="call-exp-container">
          ...
          >
            ...
            <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", padding: "2rem 1.5rem", zIndex: 10 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "0.5rem" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                  ...
                  <span style={{ fontSize: "0.8rem", color: "#9ca3af", letterSpacing: "1px", textTransform: "uppercase" }}>
                    {callState === "connecting" ? "Connecting" : (callState === "ended" ? "Call Ended" : "Live Call")}
                  </span>
                </div>
                {callState === "connected" && (
              ...
              <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
                ...
                <span style={{ fontSize: "0.9rem", color: "#6b7280" }}>Livelihood Counsellor</span>
              </div>

              {/* End Screen Content */}
              {callState === "ended" && (
                <div style={{ width: "100%", marginBottom: "2rem", textAlign: "center" }}>
                  <p style={{ fontSize: "0.9rem", color: "#10b981", marginBottom: "1rem" }}>Livelihood profile prepared.</p>
                  <button 
                    onClick={onClose}
                    style={{
            ...
            <AnimatePresence>
              {showRecommendation && (
                ...
                >
                  ...
                  <h4 style={{ fontSize: "1.2rem", fontWeight: "700", marginBottom: "0.5rem" }}>Smartphone Repair Technician</h4>
                  
                  <div style={{ display: "flex", flexDirection: "column", gap: "0.25rem", color: "#a7f3d0", fontSize: "0.85rem" }}>
                    <div style={{ display: "flex", gap: "0.5rem" }}>
                      <span style={{ opacity: 0.7 }}>Center:</span>
                      <span>PMKK Nalanda (4.2 km)</span>
                    </div>
                    <div style={{ display: "flex", gap: "0.5rem" }}>
                      <span style={{ opacity: 0.7 }}>Next Batch:</span>
                      <span>12 Oct</span>
                    </div>
                  </div>
                  ...
                  {callState === "ended" && (
                    ...
                    >
                      ...
                      Livelihood Pack sent via WhatsApp
                    </motion.div>
                  )}
                </motion.div>
              )}
